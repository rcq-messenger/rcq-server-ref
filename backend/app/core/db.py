...
async def init_db() -> None:
    from app.models import user, contact, message, group, device_token, prekey, device, audio_room, report, news, invite, queue_cursor, federation, capability, broker, access_token, server_setting, uin_epoch, owned_uin, relay_inquiry, mailbox_seq, group_log, vault, island_logo, site, uin_sale  # noqa: F401  (register tables)
